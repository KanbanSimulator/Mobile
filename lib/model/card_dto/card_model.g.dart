...
_$_CardModel _$$_CardModelFromJson(Map<String, dynamic> json) => _$_CardModel(
      ...
      blockerCompleted: json['blockerCompleted'] as int?,
      blockerRemaining: json['blockerRemaining'] as int?,
...
Map<String, dynamic> _$$_CardModelToJson(_$_CardModel instance) =>
    <String, dynamic>{
      ...
      'blockerCompleted': instance.blockerCompleted,
      'blockerRemaining': instance.blockerRemaining,
